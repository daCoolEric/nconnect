        ...
        <div className="//outline //outline-blue-700 w-screen h-fit">
          <div className="//outline //outline-red-700 w-11/12  mt-4  m-auto h-fit">
            <p className="w-fit //outline-blue-700 ">
              We are responsible for the official registration of citizens
              within our jurisdiction and beyond. We ensure that individuals are
              properly documented and recognized as legal residents or citizens
              of the Republic of Ghana. We maintain up-to-date records of
              residents, including vital information such as names, accurate
              date of births, marital status, employment status, and current
              residential addresses and more.
            </p>
          </div>
