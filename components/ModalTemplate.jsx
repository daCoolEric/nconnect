      ...
      <div className="w-full h-full divide-y //outline //outline-red-500 flex flex-col justify-evenly">
        ...
        <div className="-mt-px flex divide-x  divide-gray-200">
          <div className="flex w-0 flex-1 ">
            <button className="relative -mr-px inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-bl-lg border border-transparent py-4 text-xl font-semibold text-gray-900">
              {positive_response}
            </button>
          </div>
          <div className="-ml-px flex w-0 flex-1">
            <button className="relative inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-br-lg border border-transparent py-4 text-xl font-semibold text-gray-900">
              {negative_response}
            </button>
          </div>
        </div>
